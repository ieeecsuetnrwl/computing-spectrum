...
const VersionCard = ({ children, description, number, version, onDownload }: Props) => {
    return (
        <div
        ...
        >
            ...
            <div className="p-8 flex-1 flex flex-col">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-transparent border-2 border-[#F9A31A] text-[#F9A31A] font-bold text-sm tracking-wider transition-all duration-300 hover:bg-[#F9A31A] hover:text-[#1a1a1a] hover:translate-x-1"
                >
                    DOWNLOAD →
                </button>
            </div>
